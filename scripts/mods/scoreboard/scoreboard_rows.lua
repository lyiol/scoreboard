...
mod.scoreboard_rows = {
	...
	{name = "subheader_defense",
		text = "row_subheader_defense",
		more_important = true,
		group = "defense",
		is_subheader = true,
		validation = "ASC",
	...
	-- Downs and Deaths
	{name = "player_downs_and_deaths",
		text = "row_downs_deaths",
		validation = "ASC",
		iteration = "ADD",
		summary = {
			"player_downs",
	...
	{name = "player_downs",
		...
		iteration = "ADD",
		group = "defense",
		parent = "player_downs_and_deaths",
		setting = "plugin_revived_rescued",
	},
	{name = "player_deaths",
		text = "row_downs_deaths",
	...
	--]]
	{name = "damage_total_subheader",
		text = "subheader_total_damage_dealt",
		more_important = true,
		group = "offense",
		is_subheader = true,
		validation = "ASC",
    ...
    {name = "melee_damage_dealt",
        text = "row_melee_damage_dealt",
        validation = "ASC",
		iteration = "ADD",
		group = "offense",
		less_important = true,
    ...
    {name = "ranged_damage_dealt",
        text = "row_ranged_damage_dealt",
        validation = "ASC",
		iteration = "ADD",
		group = "offense",
		less_important = true,
    },
    {name = "other_damage_dealt",
        text = "row_other_damage_dealt",
        validation = "ASC",
		iteration = "ADD",
		group = "offense",
		less_important = true,
	...
	--]]
	{name = "damage_breakdown_subheader",
		text = "subheader_damage_breakdown",
		more_important = true,
		group = "offense",
		is_subheader = true,
		validation = "ASC",
	...
	--]]
	{name = "damage_others_subheader",
		text = "subheader_damage_others",
		more_important = true,
		group = "offense",
		is_subheader = true,
		validation = "ASC",
...
mod.register_scoreboard_row = function(self, this_mod, template)
	...
	return {
        ...
        less_important = template.less_important,
		more_important = template.more_important,
		is_empty = template.is_empty,
		is_subheader = template.is_subheader,
